<?php
//include('../../BD/verificar_sesion.php');
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <div class="row h-100 flex-column-reverse w-100">
        <nav class="col-12 col-md-3-2 sidebar shadow sidebar-hidden pe-0 position-fixed" id="sidebar">
            ...
            <ul class="mt-4">
                ...
                <a class="salir w-100 pe-3" href="../../BD/cerrar_sesion.php">
                    <li class=" my-2">
            ...
            <form name="formulario_animales">
                <div class="container">
                    <header class="encabezado-filtro">
                        <div class="row g-0">
                            ...
                            <div class="col-sm-2 filtro pb-2 ps-3">
                                <a href="#" class="link" id="aprobada">Aprobadas</a>
                            </div>
                            <div class="col-sm-2 filtro pb-2 ps-3">
                                <a href="#" class="link" id="rechazada">Rechazadas</a>
                            </div>
                ...
                <div class="container">
                    <div class="input-wrapper">
                        <input id="busqueda" type="search" placeholder="Nombre" onkeyup="filtro()">
                        <svg xmlns="http://www.w3.org/2000/svg" class="input-icon" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd" />
                        </svg>
                    </div>
                    
                    <button id="perro" class="btn-opcion" onclick="filtro_tipo_mascota('Perro')"> <img id="img-dog" src="../../img/recursos/perro_gris.png"><img id="img-dog-hover" src="../../img/recursos/perro_azul.png"> Perro</button>  
                    <button id="gato" class="btn-opcion" onclick="filtro_tipo_mascota('Gato')"> <img src="../../img/recursos/gato_gris.png"  id="img-cat"><img id="img-cat-hover" src="../../img/recursos/gato_azul.png"> Gato</button>
                    <button id="adop" class="btn-opcion" onclick="filtro_tipo_form('Adop')"> <img src="../../img/recursos/adoptar_gris.png" id="img-adopcion"><img id="img-adopcion-hover" src="../../img/recursos/adoptar_azul.png"> Adopción</button>
                    <button id="hogar" class="btn-opcion" onclick="filtro_tipo_form('Hogar temporal')"> <img src="../../img/recursos/temporal_gris.png" id="img-temporal"><img id="img-temporal-hover" src="../../img/recursos/temporal_azul.png"> temporal</button>             
                    <br><br>
                    <table class="tabla table-hover" id="tbl">
                        <tr class="row" id="encabezado">
                            <th class="col-sm-2 g-0 ps-2">
                                Mascota Solicitada
                            </th>
                            <th class="col-sm-2">
                                Tipo de Solicitud
                            ...
                            <th class="col-sm-2 g-0">
                                Tipo
                            </th>
                        </tr>
                            <?php
                                include('..//..//BD//cargar_tabla.php');
                                $d=new obtener;
                                echo $d->solicitudes();
                            ?>
