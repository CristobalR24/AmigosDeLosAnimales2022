...
<body>
    ...
    <nav class="col-12 col-md-3-2 sidebar shadow sidebar-hidden pe-0" id="sidebar">
            ...
            <ul class="mt-4">
                ...
                <a href="lista_mascota.php" class="a_color">
                    <li class="my-2">
                ...
                <a class="salir w-100 pe-3 a_color">
                    <li class=" my-2">
        ...
        <main class="col-md-9 h-100 p-0 contenido"> 
            ...
            <div class="container">
                <header class="header">
                    <div class="row">
                        <div class="col-sm-2">
                            <a id="espera" class="a_color">En espera</a>
                        </div>
                        <div class="col-sm-2">
                            <a id="aprobada" class="a_color">Aprobadas</a>
                        </div>
                        <div class="col-sm-2">
                            <a id="rechazada" class="a_color">Rechazadas</a>
                        </div>
                    </div>
                </header>
            </div>
